...
export const CODE_EXPLANATIONS: Explanation[] = [
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <em>substring</em>, starts from the beginning (index{" "}
        <CodeSegment>0</CodeSegment>) of the <CodeSegment>sequence</CodeSegment>{" "}
        string and includes all characters up to, but not including, the{" "}
        <CodeSegment>k</CodeSegment>-th character in the sequence.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <>
        In each iteration of the loop, the k-mer is shifted right by one
        position. The first character of the{" "}
        <CodeSegment>tempSequence</CodeSegment> is removed and a new character
        is appended from the <CodeSegment>sequence</CodeSegment>:
